...
/*   Updated: 2022/03/26 19:11:13 by hfast            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int hot_keys(int keycode, t_game *game)
{
    ...
    if (keycode == 53)
        exit(0);
	mlx_put_image_to_window(game->mlx, game->window, game->wall, 0 * 110, 0 * 110);
	mlx_put_image_to_window(game->mlx, game->window, game->wall, 1 * 110, 0 * 110);
